...
public class ComputerSience extends AppCompatActivity {
    ...
    public void ClickComputerSience1(View view) { MainActivity.redirectActivity(this, ComputerSience1.class); }
    public void ClickComputerSience2(View view) { MainActivity.redirectActivity(this, ComputerSience2.class); }
    public void ClickComputerSience3(View view) { MainActivity.redirectActivity(this, ComputerSience3.class); }
    public void ClickComputerSience4(View view) { MainActivity.redirectActivity(this, ComputerSience4.class); }
    public void ClickComputerSience5(View view) { MainActivity.redirectActivity(this, ComputerSience5.class); }
    public void ClickComputerSience6(View view) { MainActivity.redirectActivity(this, ComputerSience6.class); }
